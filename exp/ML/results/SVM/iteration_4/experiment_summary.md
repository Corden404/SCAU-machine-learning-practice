...
Greedy SVM iteration with StandardScaler and RBF SVC. C is fixed at 3.0 while gamma and class_weight are tuned together. Best params: {'classifier__class_weight': 'balanced', 'classifier__gamma': 0.03}.
